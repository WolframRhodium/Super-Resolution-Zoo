...
data = mx.sym.pad(data=data, mode='reflect', pad_width=(0, 0, 0, 0, 7, 7, 7, 7))
conv1_layer = mx.symbol.Convolution(name='conv1_layer', data=data, num_filter=16, pad=(0, 0), kernel=(3,3), stride=(1,1), no_bias=False, dilate=(1, 1), num_group=1, layout='NCHW')
...
conv4_layer = mx.symbol.Convolution(name='conv4_layer', data=conv3_relu_layer, num_filter=128, pad=(0, 0), kernel=(3,3), stride=(1,1), no_bias=False, dilate=(1, 1), num_group=1, layout='NCHW')
...
conv6_layer = mx.symbol.Convolution(name='conv6_layer', data=conv5_relu_layer, num_filter=256, pad=(0, 0), kernel=(3,3), stride=(1,1), no_bias=False, dilate=(1, 1), num_group=1, layout='NCHW')
conv6_relu_layer = mx.symbol.LeakyReLU(name='conv6_relu_layer', data=conv6_layer, act_type='leaky', slope=0.100000)
conv7_layer = mx.symbol.Deconvolution(name='conv7_layer', data=conv6_relu_layer, num_filter=3, pad=(3, 3), kernel=(4,4), stride=(2,2), no_bias=False, dilate=(1, 1), num_group=1, layout='NCHW')
