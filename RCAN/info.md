...
# RCAN_BIX8
sr_args = dict(up_scale=8, is_rgb_model=True, pad=None, crop=None, pre_upscale=False, merge_source=False, is_caffe_model=False, normalize_mean=(0.4488, 0.4371, 0.4040), normalize_std=(1., 1., 1.), dynamic_range=255)
